...
@Autonomous(name = "FFAuto_With_OpenCV_BLUE_SIDE_ALT", group = "Concept")
public class FFAuto_With_OpenCV_BLUE_SIDE_ALT extends LinearOpMode{
    //Webcam variable
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            StrafeRightforTime(0.5,.85);
            driveForward(0.5, 7.4);
            ...
            */
            ...
            sleep(1000);
            turnRight(0.55, 0.5);
            StrafeRightforTime(0.5,.7);
            driveReverse(1,70);
            sleep(500);
            StrafeLeftforTime(.5, .9);
            stop();
            /*
            robot.arm.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
            if (level == 1) {
