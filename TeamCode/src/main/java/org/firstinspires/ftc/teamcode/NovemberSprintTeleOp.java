...
@TeleOp(name = "NovemberSprintTeleOp")
public class NovemberSprintTeleOp extends OpMode {
    ...
    public void loop() {
       ...
       // float strafePower = gamepad1.left_stick_x;
        float strafePower = gamepad1.left_stick_x;
        boolean STOP = gamepad1.start;         // Emergency Stop Button
        //Strafe
        //float diagonalPoser = ?; //Diagonal
        //float intakePower = -gamepad1.right_stick_y;
        float intakePower = -gamepad1.right_stick_y;
        robot.intake.setPower((float)intakePower);
