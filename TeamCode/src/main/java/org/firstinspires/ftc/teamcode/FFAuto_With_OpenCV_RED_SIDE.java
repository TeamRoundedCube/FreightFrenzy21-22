...
@Autonomous(name = "FFAuto_With_OpenCV_RED_SIDE", group = "Concept")
public class FFAuto_With_OpenCV_RED_SIDE extends LinearOpMode{
    //Webcam variable
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() == false) {
            if (opencv.getLocation() == FFOpenCVPipelineClass.Location.LEFT) {
                ...
                level = 3;
                telemetry.addData("Nothing Detected - Defaulted to: ",3);
                telemetry.update();
                //sleep(3000);
