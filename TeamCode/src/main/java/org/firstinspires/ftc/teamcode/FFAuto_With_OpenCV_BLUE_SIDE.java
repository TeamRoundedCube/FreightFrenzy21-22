...
@Autonomous(name = "FFAuto_With_OpenCV_BLUE_SIDE", group = "Concept")
public class FFAuto_With_OpenCV_BLUE_SIDE extends LinearOpMode {
    //Webcam variable
    OpenCvWebcam webcam;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive() == false) {
            if (opencv.getLocation() == FFOpenCVPipelineClass.Location.LEFT) {
                ...
                level = 3;
                telemetry.addData("Nothing Detected - Default Level:", level);
                telemetry.update();
                //sleep(3000);
        ...
        if (opModeIsActive()) {
            ...
            driveReverse(.5,28);
            //driveForward(.305, 2);
            //StrafeLeftforTime(0.45, 1);
            //sleep(1000);
            //StrafeRightforTime(0.1,0.3);
            turnLeft(0.25,.6);
            //sleep(1000);
            StrafeLeftforTime(0.25, 1);
            //sleep(1000);
            //StrafeLeftforTime(0.1,0.75);
            //2-21-22 Number was .5 was changed to .75
            //driveReverse(.1, 4);
            //sleep(1000);
            //StrafeLeftforTime(0.25,2);
            ...
            */
            ...
            SpinCarousel(.5, 2);
            sleep(1000);
            StrafeRightforTime(0.25, .4);
            //sleep(1000);
            //2-21-22 number was 1 changed to .5
            //StrafeRightforTime(0.5,.25);
            turnRight(.25, .5);
            //sleep(1000);
            driveForward(.5, 58);
            //sleep(1000);
            ...
            */
            ...
            //number was 2 changed to 1
            driveReverse(1, 65);
            // 2-21-22 number was 42 changed to 60
        }
    }
